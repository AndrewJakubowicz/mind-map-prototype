...
module.exports = function (graph, radialMenu, radialMenuArrowTool, currentState) {
     ...
     */
    function updateLine() {
        var line = graph.getSVGElement().selectAll("#menu-line-overlay").data(d3Data);

        var lineEnter = line.enter().append('line').attr("id", "menu-line-overlay");
        ...
        line.attr("x1", function (d) {
            ...
            return d.end.y;
        }).attr("stroke-width", 1).attr("stroke", "grey").attr("pointer-events", "none");
    }

    var d3Data = [tempDrawingArrow];
    ...
    var mousedrag = mousedown.flatMap(function (md) {
        ...
        }).takeUntil(mouseUpOnNodeObservable).finally(function () {
